...
// If your models are in backend/models, this path is correct.
...
async function seed() {
  // FIXED: Changed MONGODB_URI to MONGO_URI to match your .env
  ...
  console.log('\n🎉 Seed complete!\n');
  console.log('📧 Login using these emails now:');
